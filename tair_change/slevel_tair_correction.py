...
def create_mask(time):
    ...
    output_file = "/g/data/w48/dm5220/ancil/user_slevel/tair_change/files_for_xancil/land_mask_tair_change.nc"
...
def create_tsurf(time):
    ...
    output_file = "/g/data/w48/dm5220/ancil/user_slevel/tair_change/files_for_xancil/tsurf_tair_change.nc"
